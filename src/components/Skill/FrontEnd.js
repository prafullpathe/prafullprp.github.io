...
import { SiMysql,SiIota,SiPython} from "react-icons/si";
import { DiHtml5,DiJava,DiCss3,DiMysql,
    DiJavascript1,DiAws,
     DiMongodb, DiNodejs } from "react-icons/di";
function FrontEnd() {
    return (
